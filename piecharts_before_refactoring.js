...
// let District = Object.values(data.District);
...
function getData(state_sel) {
    ...
    if (state_sel == 'Alabama') {
        sel_state_data = alabama;
    }
    else if (state_sel == 'Alaska') {
        sel_state_data = alaska;
    }
...
// console.log('about to add event handler')
...
function updateChart(newdata) {
    piechart.destroy()
    console.log('after update chart def')
    const ctx = document.getElementById('piechart').getContext('2d');
